...
<header style="position: relative; height: 300px; max-width: 1220px; margin: 0 auto;">
    <div class="center-container">
        <img src="${pageContext.request.contextPath}/resources/images/header-bg.jpg" alt="배너" class="header-img">
    </div>

    <div class="left-container p-3 bg-white border rounded" style="width: 300px; height: 300px; overflow-y: auto;">
        <h6 class="fw-bold">카테고리별 인기 순위</h6>
        <ul id="trendResultHeader" class="list-group small"></ul> 
    </div>

    <div class="right-container"
        style="padding: 10px; border: 1px solid #ddd; border-radius: 5px; background-color: #f9f9f9; margin-top: 10px; display: block;">
